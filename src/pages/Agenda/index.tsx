...
const Agenda = () => {
    ...
    const [shouldRefetch, setShouldRefetch] = useState(true); // Estado de controle
    ...
    const fetchAgendamentos = async () => {
        ...
        try {
            ...
            console.log(agendamentosRequest.original)
    ...
    useEffect(() => {
        if (shouldRefetch) {
            fetchAgendamentos();
            setShouldRefetch(false); // Resetando o estado de controle após a execução
        }
    }, [shouldRefetch]); // O useEffect será disparado apenas quando `shouldRefetch` mudar
            ...
            {loading ? (
                ...
                <>
                    ...
                    <section className="bg-white flex w-full gap-5 p-4">
                        ...
                        />
                        <AppointmentList date={date} setShouldRefetch={setShouldRefetch} />
                    </section>
                </>
            )}
        </div>
