...
export const handleConfirmAppointment = async (row: any, navigate: ReturnType<typeof useNavigate>, setShouldRefetch:any) => {
    const statusTrue = {
    ...
    try {
        ...
        setShouldRefetch(true); // Dispara o useEffect para refazer a requisição
